  ...
  protocolSection: {
    ...
    outcomesModule: {
      ...
      secondaryOutcomes: [
        ...
        {
          measure: "Area Under the Concentration-time Curve (AUC) of MK-1045",
          description:
        ...
        {
          measure: "Accumulatio Ratio Based on Cmax (RAC-Cmax) of MK-1045",
          description:
    ...
    contactsLocationsModule: {
      ...
      locations: [
        {
          facility: "Fifth Medical Center of PLA General Hospital ( Site 0005)",
          status: "RECRUITING",
          city: "Beijing",
